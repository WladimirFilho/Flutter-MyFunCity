...
class QuestionsKidsFriendlyPage extends StatefulWidget {
  ...
  @override
  State<QuestionsKidsFriendlyPage> createState() => _QuestionsKidsFriendlyPageState();
}
            ...
            children: [
              ...
              if (questionThemekidsIndex == 0)
                SliderVoteWidget(
                  ...
                  onPress: (int votingIndex) {
                    answers.addAll(
                      {widget.docFromFirebase['questions'][questionThemekidsIndex]: votingIndex},
                    );
                  },
                ),
              ...
              ElevatedButton(
                onPressed: () {
                  setState(
                    () {
                      if (questionThemekidsIndex < widget.docFromFirebase['questions'].length - 1) {
