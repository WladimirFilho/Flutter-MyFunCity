...
import '/pages/survey_pages/survey_page_tree_pages.dart';

// ignore: prefer_const_literals_to_create_immutables

class SurveyPageTwo extends StatefulWidget {
  SurveyPageTwo({super.key});

  @override
  State<SurveyPageTwo> createState() => _SurveyPageTwoState();
}
      ...
      body: Column(
        children: [
          Container(
            ...
            height: 60,
            color: Color.fromARGB(255, 44, 183, 65),
          ),
          Padding(
              ...
              InkWell(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => SurveyPageTree(),
                    ),
                  );
                },
